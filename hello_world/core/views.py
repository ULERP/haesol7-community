...
def guide_page(request, slug):
            ...
            'sections': [
                {
                    'title': '해솔7 지킴이란?',
                    'icon': '🌿',
                    'content': '해솔마을 7단지 입주민 전용 커뮤니티입니다. 이웃과 소통하고, 단지 정보를 나누며, 함께하는 공간을 만들어갑니다.',
                },
                {
                    'title': '💬 대화하기',
                    'icon': '💬',
                    'content': '전체채팅, 소모임 채팅, 1:1 다이렉트 메시지로 이웃과 자유롭게 소통하세요. 실시간으로 대화할 수 있습니다.',
                },
                {
                    'title': '📋 기록하기',
                    'icon': '📋',
                    'content': '공지사항, 생활정보, 여가활동, 나눔/장터 등 다양한 게시판을 이용할 수 있습니다. 사진과 함께 게시물을 작성해보세요.',
                },
                {
                    'title': '🤝 함께하기',
                    'icon': '🤝',
                    'content': '소모임을 만들거나 참여하고, 봉사활동·설문조사에 함께해보세요. 이웃과 더 가까워질 수 있습니다.',
                },
                {
                    'title': '📢 단지소식',
                    'icon': '📢',
                    'content': '관리사무소 공지, 캘린더 일정, 민원 접수까지 단지의 모든 소식을 한 곳에서 확인하세요.',
                },
                {
                    'title': '🏅 포인트 & 온기',
                    'icon': '🏅',
                    'content': '활동할수록 마일리지 포인트가 쌓이고, 이웃에게 온기를 나눌 수 있습니다. 배지를 모아 나만의 프로필을 꾸며보세요.',
                },
            ],
        },
        'rules': {
            ...
            'sections': [
                {
                    'title': '기본 원칙',
                    'icon': '✅',
                    'content': '해솔7 지킴이는 해솔마을 7단지 입주민을 위한 공간입니다. 서로 존중하고 배려하는 따뜻한 커뮤니티를 함께 만들어가요.',
                },
                {
                    'title': '금지 행위',
                    'icon': '🚫',
                    'content': '욕설·비방·혐오 표현 금지 / 허위사실 유포 금지 / 개인정보 무단 공유 금지 / 상업적 광고·홍보 금지 / 타인을 괴롭히는 행위 금지',
                },
                {
                    'title': '게시물 작성 규칙',
                    'icon': '📝',
                    'content': '게시판 성격에 맞는 글을 작성해주세요. 같은 내용의 반복 게시(도배)는 삼가주세요. 타인의 저작물을 무단으로 게재하지 마세요.',
                },
                {
                    'title': '채팅 이용 규칙',
                    'icon': '💬',
                    'content': '채팅방에서도 기본 예절을 지켜주세요. 도배·광고·불쾌한 내용은 자제해주시고, 상대방이 불편할 수 있는 메시지는 삼가주세요.',
                },
                {
                    'title': '제재 안내',
                    'icon': '⚠️',
                    'content': '이용수칙 위반 시 경고 후 게시물 삭제, 반복 위반 시 계정 이용 제한 조치가 취해질 수 있습니다. 건전한 커뮤니티 문화를 위해 협조해주세요.',
                },
                {
                    'title': '신고 방법',
                    'icon': '🚨',
                    'content': '부적절한 게시물이나 이용자를 발견하면 민원 접수 또는 관리자에게 직접 문의해주세요. 신고 내용은 익명으로 처리됩니다.',
                },
            ],
        },
        'verify': {
            ...
            'sections': [
                {
                    'title': '회원가입 방법',
                    'icon': '📝',
                    'content': '상단 메뉴의 [가입] 버튼을 클릭하세요. 아이디·이름·닉네임·동호수·연락처를 입력하면 가입 신청이 완료됩니다.',
                },
                {
                    'title': '입주민 인증이란?',
                    'icon': '✅',
                    'content': '해솔마을 7단지 실제 입주민임을 확인하는 절차입니다. 인증 완료 시 모든 기능을 제한 없이 이용할 수 있습니다.',
                },
                {
                    'title': '인증 방법 1 — 고지서 제출',
                    'icon': '📄',
                    'content': '가입 시 관리비 고지서 사진을 첨부하면 빠르게 인증됩니다. 고지서에서 동호수와 성명이 확인되면 관리자가 승인합니다.',
                },
                {
                    'title': '인증 방법 2 — 관리자 확인',
                    'icon': '👤',
                    'content': '고지서 없이 가입하면 관리자가 거주 여부를 확인 후 승인합니다. 다소 시간이 소요될 수 있습니다.',
                },
                {
                    'title': '인증 전 이용 가능한 기능',
                    'icon': '🔓',
                    'content': '홈 화면 조회, 공지사항·게시물 열람이 가능합니다. 게시물 작성·채팅·소모임 등은 인증 후 이용하실 수 있습니다.',
                },
                {
                    'title': '문의',
                    'icon': '💌',
                    'content': '가입이나 인증 관련 문의는 민원 접수 게시판을 이용하시거나 관리사무소로 연락주세요.',
                },
            ],
        },
    }
    ...
    all_guides = [
        {'slug': 'intro',  'title': '서비스 소개',   'icon': '🏠', 'desc': '해솔7 지킴이의 주요 기능을 소개합니다'},
        {'slug': 'rules',  'title': '이용수칙',      'icon': '📋', 'desc': '커뮤니티 이용 시 지켜주세요'},
        {'slug': 'verify', 'title': '가입 & 인증',   'icon': '🔐', 'desc': '입주민 인증 방법을 안내합니다'},
    ]
