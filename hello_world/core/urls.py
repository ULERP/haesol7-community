...
urlpatterns = [
    ...
    path('volunteer/<int:pk>/confirm/', views.volunteer_confirm, name='volunteer_confirm'),
    path('volunteer/<int:pk>/complete/',views.volunteer_complete,name='volunteer_complete'),
    ...
    path('groups/<int:pk>/invite-respond/',                views.group_invite_respond, name='group_invite_respond'),
